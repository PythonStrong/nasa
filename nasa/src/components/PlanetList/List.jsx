  ...
  return (
    <div>
          ...
          <div class="planet mercury">
            <div class="planet_description mercury">
              ...
              <p>
                ...
                all the other planets, which is why Romans named it after their
          ...
          <div class="planet earth">
            ...
            <div class="planet_description earth">
              ...
              <p>
                ...
                atmosphere containing free oxygen, oceans of liquid water on its
        ...
        <div class="solar_systm">
          <div class="planet jupiter">
            ...
            <div class="planet_description jupiter">
              ...
              <p>
                Characteristics: Proxima Centauri b is located within the
                habitable zone of the red dwarf Proxima Centauri, meaning it
                could have conditions that allow liquid water to exist on its
                surface. It is similar in size to Earth, with an estimated mass
                of about 1.17 times that of Earth. However, the planet faces
                challenges, such as intense stellar flares from its host star,
                which could strip away its atmosphere, potentially affecting
                habitability.
              </p>
      ...
      <div class="panel">
        ...
        <h2>
          Mars and Earth hasafsdfsfaasfve approximately the same landmass.
        </h2>
        <p>
